---
description: "Migrate from madge to rev-dep, measured up to 92x faster: replace circular-dependency and orphan detection with a config-driven suite (note: rev-dep is not a graph visualizer)."
