...
func NodeModulesCmd(
	...
	excludeFiles := []string{}
	absolutePathToEntryPoints, discoveredFiles := resolve.ResolveEntryPointsFromPatterns(cwd, entryPoints, excludeFiles)
	...
	minimalTree, _, resolverManager := resolve.GetMinimalDepsTreeForCwd(cwd, ignoreType, excludeFiles, upfrontFilesList, packageJson, tsconfigJson, conditionNames, followMonorepoPackages, nil)
