...
func NodeModulesCmd(
	...
	minimalTree, _, resolverManager := resolve.GetMinimalDepsTreeForCwd(cwd, ignoreType, excludeFiles, nil, upfrontFilesList, tsconfigJson, conditionNames, followMonorepoPackages, nil, nodeModulesMatchingStrategy)
	...
	usedNodeModules := GetUsedNodeModulesFromTree(minimalTree, cwdNodeModules, cwd, pkgJsonFieldsWithBinaries, filesWithBinaries, filesWithModules, tsconfigJson, nil)
