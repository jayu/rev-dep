...
func TestPackageJsonExportsDifferentSpecificity(t *testing.T) {
	...
	minimalTree, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
...
func TestPackageJsonExportsConditionalExports(t *testing.T) {
	...
	minimalTreeDev, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"development"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeProd, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"production"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeDefault, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
...
func TestPackageJsonExportsDeepNestedConditionalExports(t *testing.T) {
	...
	minimalTreeDevNode, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"development", "node"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeDevDefault, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"development"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeProdBrowser, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"production", "browser"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeProdDefault, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{"production"}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
	...
	minimalTreeBlocked, _, _ := GetMinimalDepsTreeForCwd(cwd, ignoreTypeImports, excludeFiles, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{FollowAll: true}, nil)
