---
title: Consistent Import Conventions
description: Enforce consistent import styles (like relative vs. absolute imports) across your codebase to maintain clear domain boundaries and improve readability.
---
...
- `domains` (array): The domains to enforce conventions between. Use **one** style for the whole array - simplified and detailed cannot be mixed:
    - **Simplified:** glob-pattern strings (e.g., `src/utils/*`), matched through your `tsconfig.json` paths.
    - **Detailed:** objects, each with:
