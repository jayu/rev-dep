...
func TestFindCircularDepsWithTypeImports(t *testing.T) {
	...
	minimalDepsTree, sortedFiles, _ := GetMinimalDepsTreeForCwd(cwd, false, []string{}, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{}, nil)
...
func TestFindCircularDepsWithoutTypeImports(t *testing.T) {
	...
	minimalDepsTree, sortedFiles, _ := GetMinimalDepsTreeForCwd(cwd, true, []string{}, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{}, nil)
