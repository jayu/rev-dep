---
description: "Compare rev-dep with knip, dependency-cruiser, depcheck, madge, jscpd, dpdm, ts-prune, ts-unused-exports, unimported, skott, eslint-plugin-import, good-fences, sheriff and npm-check."
title: Comparison with other tools
sidebar_label: Overview
---

<head>
  <title>Rev-dep vs knip, madge, jscpd, depcheck, dependency-cruiser and more</title>
</head>
