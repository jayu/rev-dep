---
title: Find Unused Node Modules
description: Detect unused dependencies from your `package.json` to reduce bundle size, improve maintainability, and speed up installations.
---
...
Below is an example of how `unusedNodeModulesDetection` fits within the `workspaces` array. It demonstrates defining general production and development entry points at the **workspace level**.
