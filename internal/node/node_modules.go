...
// A string value means a single binary named after the package itself; an object maps
// binary names to paths. Names are sorted so the result does not depend on map iteration
// order. Anything else (absent, null, malformed) declares no binaries.
