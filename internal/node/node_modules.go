...
func NodeModulesCmd(
	...
	minimalTree, _, resolverManager := resolve.GetMinimalDepsTreeForCwd(cwd, ignoreType, excludeFiles, nil, upfrontFilesList, packageJson, tsconfigJson, conditionNames, followMonorepoPackages, nil)
