...
func getEntryPointFiles(minimalTree model.MinimalDependencyTree, mainEntryPoint string, rootFilePath string) func(w http.ResponseWriter, req *http.Request) {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		graph := graph.BuildDepsGraphForMultiple(minimalTree, []string{filePath}, nil, false, false)
...
func explainDependency(minimalTree model.MinimalDependencyTree, mainEntryPoint string, rootFilePath string) func(w http.ResponseWriter, req *http.Request) {
	return func(w http.ResponseWriter, req *http.Request) {
		startTime := time.Now()
		query := req.URL.Query()
		filePath := query.Get("filePath")
		...
		graphMultiple := graph.BuildDepsGraphForMultiple(minimalTree, []string{entryPoint}, &filePath, false, false)
...
func StartServer(minimalTree model.MinimalDependencyTree, mainEntryPoint string, rootFilePath string) {
