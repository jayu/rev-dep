...
func TestFindCircularDepsWithTypeImports(t *testing.T) {
	...
	minimalDepsTree, sortedFiles, _ := GetMinimalDepsTreeForCwd(cwd, false, []string{}, nil, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{}, nil)
...
func TestFindCircularDepsWithoutTypeImports(t *testing.T) {
	...
	minimalDepsTree, sortedFiles, _ := GetMinimalDepsTreeForCwd(cwd, true, []string{}, nil, []string{}, "", "", []string{}, FollowMonorepoPackagesValue{}, nil)
