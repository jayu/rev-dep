...
func TestImportSyntaxParsingOneByOne(t *testing.T) {
	examples := []struct {
		...
		{code: `export * from "module-name"`, kind: 0},
		{code: `export * as name1 from "module-name"`, kind: 0},
		{code: `export { name1,  nameN } from "module-name"`, kind: 0},
		{code: `export { import1 as name1, import2 as name2,  nameN } from "module-name"`, kind: 0},
		{code: `export { default } from "module-name"`, kind: 0},
		{code: `export { default as name1 } from "module-name"`, kind: 0},
		{code: `export { type MyType } from "./types"`, kind: 0},
		{code: `export type { MyType } from "./types"`, kind: 1},
		{code: `export { default, type MyType2 } from "./types"`, kind: 0},
		{code: `import defaultExport from "module-name"`, kind: 0},
		{code: `import * as name from "module-name"`, kind: 0},
		{code: `import { export1 } from "module-name"`, kind: 0},
		{code: `import { export1 as alias1 } from "module-name"`, kind: 0},
		{code: `import { default as alias } from "module-name"`, kind: 0},
		{code: `import { export1, export2 } from "module-name"`, kind: 0},
		{code: `import { export1, export2 as alias2 } from "module-name"`, kind: 0},
		{code: `import { "string name" as alias } from "module-name"`, kind: 0},
		{code: `import defaultExport, { export1 } from "module-name"`, kind: 0},
		{code: `import defaultExport, * as name from "module-name"`, kind: 0},
		{code: `import "module-name"`, kind: 0},
		{code: `import { type MyType2 } from "./types"`, kind: 0},
		{code: `import type {  MyType2 } from "./types"`, kind: 1},
		{code: `import fnA, { type MyType3 } from "./types"`, kind: 0},
		{code: `import fnA, { type MyType3, MyVal } from "./types"`, kind: 0},
	}
