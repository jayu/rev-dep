...
If you are consuming the JSON programmatically, validate against the published schema in `output-schema/1.1.schema.json` in the repository (the `version` field in the output tells you which schema applies).
