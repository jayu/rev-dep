...
Additionally set of detectors for each workspace is executed in parallel and particular detectors within each workspace are also executed in parallel utilizing all available CPU cores in optimal way.
...
<p align="center">
<img src="/img/demo.png" alt="Rev-dep config execution CLI output" width="490"/>
</p>
...
New to config-based checks? Follow a step-by-step setup with the 
